    ...
    return (
        <div className="space-y-4 py-4 flex flex-col h-full bg-[#111827] text-white">
            ...
            <div className="space-y-1 px-3 py-2">
                {routes.map((route) => (
                    <Link href={route.href} key={route.href} className="text-sm group flex p-3 w-full justify-start font-medium 
                    ursor-pointer hover:text-white hover:bg-white/10 rounded-lg transition">
